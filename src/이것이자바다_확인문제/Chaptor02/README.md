# 📝 Java Chapter 02: 변수와 타입 실력 점검 퀴즈 (통합본)
...
# 📝 Java Chapter 02: 변수와 타입 실력 점검 퀴즈
...
> ➌ short shortValue = charValue; (❌ 에러!)
> ➍ double doubleValue = byteValue;

**정답: ➌**
**해설:** char는 0~65535 범위로 음수가 없습니다. 반면 short는 음수를 포함하는 타입이므로, char에서 short로의 자동 타입 변환은 불가능합니다.
...
>
> ➊ byte result = byteValue + byteValue; (❌ 에러!)
